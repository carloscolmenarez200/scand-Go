...
public class Sender extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("sourceOfFunds"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.sourceOfFunds = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.sourceOfFunds = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.sourceOfFunds!=null?this.sourceOfFunds:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
