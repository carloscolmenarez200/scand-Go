...
public class PinDebitPurchaseReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("networkCode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.networkCode = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.networkCode = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==4)
        {
            return this.networkCode!=null?this.networkCode:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==5)
        {
