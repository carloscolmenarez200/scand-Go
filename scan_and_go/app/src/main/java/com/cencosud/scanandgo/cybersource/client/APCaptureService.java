...
public class APCaptureService extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("isFinal"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.isFinal = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.isFinal = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.isFinal!=null?this.isFinal:SoapPrimitive.NullSkip;
        }
        return null;
    }
