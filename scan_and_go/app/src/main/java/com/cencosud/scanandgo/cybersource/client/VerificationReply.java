...
public class VerificationReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("verifiedDateTime"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.verifiedDateTime = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.verifiedDateTime = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==3)
        {
            return this.verifiedDateTime!=null?this.verifiedDateTime:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==4)
        {
