...
public class HostedDataRetrieveService extends AttributeContainer implements KvmSerializable
{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.profileID!=null?this.profileID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
            return this.tokenValue!=null?this.tokenValue:SoapPrimitive.NullSkip;
        }
        return null;
    }
