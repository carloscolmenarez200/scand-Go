...
public class BankTransferReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("accountHolder"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.accountHolder = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.accountHolder = (String)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("bankCity"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.bankCity = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.bankCity = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("bankCountry"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.bankCountry = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.bankCountry = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("paymentReference"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.paymentReference = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.paymentReference = (String)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("bankSwiftCode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.bankSwiftCode = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.bankSwiftCode = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("bankSpecialID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.bankSpecialID = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.bankSpecialID = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.accountHolder!=null?this.accountHolder:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
        ...
        if(propertyIndex==4)
        {
            return this.bankName!=null?this.bankName:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==5)
        {
            return this.bankCity!=null?this.bankCity:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==6)
        {
            return this.bankCountry!=null?this.bankCountry:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==7)
        {
            return this.paymentReference!=null?this.paymentReference:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==8)
        {
        ...
        if(propertyIndex==9)
        {
            return this.bankSwiftCode!=null?this.bankSwiftCode:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==10)
        {
            return this.bankSpecialID!=null?this.bankSpecialID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==11)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "bankCountry";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==7)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "paymentReference";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==8)
        {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "bankSwiftCode";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==10)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "bankSpecialID";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==11)
        {
