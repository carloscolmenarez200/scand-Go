...
public class APUpdateMandateService extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("esign"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.esign = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.esign = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.esign!=null?this.esign:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
