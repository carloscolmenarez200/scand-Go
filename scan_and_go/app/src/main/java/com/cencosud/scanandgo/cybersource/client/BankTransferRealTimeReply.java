...
public class BankTransferRealTimeReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("formMethod"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.formMethod = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.formMethod = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("formAction"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.formAction = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.formAction = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.formMethod!=null?this.formMethod:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
            return this.formAction!=null?this.formAction:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "formMethod";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==2)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "formAction";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==3)
        {
