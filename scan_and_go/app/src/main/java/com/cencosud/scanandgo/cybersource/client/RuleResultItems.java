...
public class RuleResultItems extends Vector< RuleResultItem> implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                RuleResultItem j1= (RuleResultItem)__envelope.get(j,RuleResultItem.class,false);
                add(j1);
            }
        }
}
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "ruleResultItem";
        info.type = RuleResultItem.class;
