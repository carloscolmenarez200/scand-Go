...
public class ECAuthenticateReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("checkpointSummary"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.checkpointSummary = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.checkpointSummary = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("fraudShieldIndicators"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.fraudShieldIndicators = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.fraudShieldIndicators = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==4)
        {
            return this.checkpointSummary!=null?this.checkpointSummary:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==5)
        {
            return this.fraudShieldIndicators!=null?this.fraudShieldIndicators:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "checkpointSummary";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==5)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "fraudShieldIndicators";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
    }
