...
public class VoidReply extends AttributeContainer implements KvmSerializable
{
    ...
    public String reversalSubmitted;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("reversalSubmitted"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.reversalSubmitted = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.reversalSubmitted = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==4)
        {
            return this.reversalSubmitted!=null?this.reversalSubmitted:SoapPrimitive.NullSkip;
        }
        return null;
    }
