...
public class issuer extends AttributeContainer implements KvmSerializable
{
    ...
    public String countryNumericCode;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("countryNumericCode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.countryNumericCode = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.countryNumericCode = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==3)
        {
            return this.countryNumericCode!=null?this.countryNumericCode:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==4)
        {
