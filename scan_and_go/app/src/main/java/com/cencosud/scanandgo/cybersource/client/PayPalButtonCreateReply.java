...
public class PayPalButtonCreateReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("encryptedFormData"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.encryptedFormData = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.encryptedFormData = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("unencryptedFormData"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.unencryptedFormData = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.unencryptedFormData = (String)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("buttonType"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.buttonType = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.buttonType = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.encryptedFormData!=null?this.encryptedFormData:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
            return this.unencryptedFormData!=null?this.unencryptedFormData:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
        ...
        if(propertyIndex==5)
        {
            return this.buttonType!=null?this.buttonType:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "encryptedFormData";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==2)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "unencryptedFormData";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==3)
        {
