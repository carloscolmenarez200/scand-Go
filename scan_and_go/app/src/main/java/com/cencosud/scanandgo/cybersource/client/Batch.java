...
public class Batch extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("batchID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.batchID = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.batchID = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.batchID!=null?this.batchID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
