...
public class PayerAuthValidateService extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("signedPARes"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.signedPARes = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.signedPARes = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.signedPARes!=null?this.signedPARes:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
