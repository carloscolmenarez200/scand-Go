...
public class ChinaPaymentReply extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("formData"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.formData = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.formData = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("verifyFailure"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.verifyFailure = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.verifyFailure = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("verifyInProcess"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.verifyInProcess = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.verifyInProcess = (String)obj;
                }
            }
            return true;
        }
        if (info.name.equals("verifySuccess"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.verifySuccess = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.verifySuccess = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==5)
        {
            return this.formData!=null?this.formData:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==6)
        {
            return this.verifyFailure!=null?this.verifyFailure:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==7)
        {
            return this.verifyInProcess!=null?this.verifyInProcess:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==8)
        {
            return this.verifySuccess!=null?this.verifySuccess:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "verifyFailure";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==7)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "verifyInProcess";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
        if(propertyIndex==8)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "verifySuccess";
            info.namespace= "urn:schemas-cybersource-com:transaction-data-1.146";
        }
    }
