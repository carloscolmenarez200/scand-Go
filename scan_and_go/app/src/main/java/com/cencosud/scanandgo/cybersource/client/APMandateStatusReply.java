...
public class APMandateStatusReply extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("dateRevoked"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.dateRevoked = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.dateRevoked = (String)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==7)
        {
            return this.dateRevoked!=null?this.dateRevoked:SoapPrimitive.NullSkip;
        }
        return null;
    }
